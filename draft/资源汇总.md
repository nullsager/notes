...
* [c++编程指南](https://chengxumiaodaren.com/)
...
* [恋恋风尘](https://gitbookcpp.llfc.club/)
* [恋恋风辰zack](https://www.yuque.com/lianlianfengchen-cvvh2)
...
* [mnn文档](https://mnn-docs.readthedocs.io/en/latest/index.html)
...
* [cmake中文教程](https://www.cccolt.top/tutorial/cmake/)
...
+ [leveldb 简明使用教程](https://zhuanlan.zhihu.com/p/699091400?utm_psn=1776415049571614720&utm_id=0)
+ [c++中文周刊](https://wanghenshui.github.io/)
+ [redis文档](https://redis.com.cn/)
+ [aigithub分析DeepWiki](https://deepwiki.com/)
+ [ai github分析 中文版](https://readmex.com/)
+ [javascript教程](https://zh.javascript.info/)
+ [CS自学社区](https://www.learncs.site/)
+ [linux系统编程手册网站](https://man7.org/)
+ [网道平台](https://wangdoc.com/)
...
+ [网络编程实战](https://time.geekbang.org/column/intro/100032701?utm_campaign=geektime_search&utm_content=geektime_search&utm_medium=geektime_search&utm_source=geektime_search&utm_term=geektime_search&tab=catalog) [对应源码](https://github.com/froghui/yolanda)
+ [《TCP/IP网络编程》学习笔记](https://github.com/riba2534/TCP-IP-NetworkNote)
+ [苏剑林](https://spaces.ac.cn/me.html)
+ [高清电影](https://www.yinfans.cc/)
+ [音乐下载](https://music.gdstudio.xyz/)
+ [latex常用数学符号](https://www.cnblogs.com/RioTian/p/14563284.html)
+ [tbox导航](https://www.tboxn.com/)
+ [迅捷画图](https://huatu.98youxi.com/home/myfile/)
+ [ip检测](https://ipjiance.com/)
+ [flowercloud](https://flower.yt/clientarea.php)
+ [zlib](https://zh.z-lib.fm/)
+ [安娜的档案](https://zh.annas-archive.org/)
+ [资源帝电子书导航](https://shu.ziyuandi.cn/)
+ [爱达杂货铺](https://adzhp.cc/)
+ [vscode代码片段生成器](https://maoshu.fun/vscode/)
+ [查询网](https://tool.ip138.com/random/)
+ [验证码](https://sms-activate.org/cn/getNumber)

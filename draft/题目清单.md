...
[827. 最大人工岛](https://leetcode.cn/problems/making-a-large-island/description/)
洪泛法
...
[936. 戳印序列](https://leetcode.cn/problems/stamping-the-sequence/description/)
字符串，拓扑排序优化
...
[P 2330 [SCOI 2005] 繁忙的都市](https://www.luogu.com.cn/problem/P2330)
最小生成树，并查集
...
[2290. 到达角落需要移除障碍物的最小数目](https://leetcode.cn/problems/minimum-obstacle-removal-to-reach-corner/description/)
01 bfs
...
[P 4799 [CEOI 2015] 世界冰球锦标赛 (Day 2)](https://www.luogu.com.cn/problem/P4799)
双向广搜，双指针，迭代器，std::span
...
[864. 获取所有钥匙的最短路径](https://leetcode.cn/problems/shortest-path-to-get-all-keys/description/)
bfs，状态压缩，分层图

[LCP 35. 电动车游城市](https://leetcode.cn/problems/DFPeFJ/description/)
dijkstra，分层图

[P 4568 [JLOI 2011] 飞行路线](https://www.luogu.com.cn/problem/P4568)
dijkstra，分层图

[P 2910 [USACO 08 OPEN] Clear And Present Danger S](https://www.luogu.com.cn/problem/P2910)
floyd

[787. K 站中转内最便宜的航班](https://leetcode.cn/problems/cheapest-flights-within-k-stops/description/)
Bellman-Ford，动态规划，滚动数组压缩
...
[P 8776 [蓝桥杯 2022 省 A] 最长不下降子序列](https://www.luogu.com.cn/problem/P8776#submit)
动态规划

[bytedance-006. 夏季特惠](https://leetcode.cn/problems/tJau2o/description/)
动态规划
